...
class ContactForm(forms.ModelForm):
    ...
    profile_picture = forms.ImageField(required=False, widget=forms.FileInput(attrs={"class": "form-control"}), label="Фото профілю")

    class meta:
        model = Contact
        field = ("first_name", "last_name", "email", "phone_number", "address","profile_picture")